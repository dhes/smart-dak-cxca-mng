...
Description: "Decision support logic for cervical cancer screening eligibility (CXCA.D2). Encodes the binding eligibility rules from Mongolia MOH Order A/641 (2020) section 2.2. Source CQL is at input/cql/CXCAD2DTScreeningEligibilityLogic.cql."
Usage:       #definition

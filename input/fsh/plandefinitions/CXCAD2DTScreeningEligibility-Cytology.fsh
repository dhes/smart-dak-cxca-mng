...
// Both are tagged bindingness = legal because both encode A/641 §2.2's
...
// A/641 §2.2 specifies different age cycles based on whether the facility
...
// Regulatory bindingness — also legal-binding (A/641 §2.2 cytology pathway)
